$(document).ready(function() {
    ...
    var name = $('.thumbs_style').eq(0).find('img').attr('src');
    var index = 0;
    ...
    $('body').append("<div id='enlarge'><div> <img id='large_img' src='" + name + "'> <img id='large_close' src='icons/close.png'> <img id='large_left' src='icons/left.png'> <img id='large_right' src='icons/right.png'> <img id='large_pause' src='icons/pause.png'> <img id='large_play' src='icons/play.png'>  </div></div> ");
